          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navigation">
              <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center me-2 active" aria-current="page" href="http://localhost:8000/dashboard">
                ...
                <li class="nav-item">
                  <a class="nav-link me-2" href="http://localhost:8000/sign-up">
        ...
        <div class="container">
          <div class="row">
              ...
              <div class="card card-plain">
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    ...
                    <a href="http://localhost:8000/sign-up" class="text-primary text-gradient font-weight-bold">Sign up</a>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
              <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden" style="background-image: url('7af4d8c481bb088952e8c9ab676b206a.jpg');
